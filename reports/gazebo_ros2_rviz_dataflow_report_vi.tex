...
\begin{enumerate}
  \item Lệnh MAVProxy được mã hóa thành gói MAVLink nào và ArduPilot xử lý ra sao?
  \item ArduPilot và ArduPilotPlugin trao đổi PWM, IMU và trạng thái mô phỏng bằng định dạng nào?
  \item Plugin tác động lên Gazebo physics và nhận dữ liệu sensor qua ECS hoặc Gazebo Transport như thế nào?
  \item Dữ liệu Gazebo được chuyển thành message ROS~2 và đi đến Gazebo GUI hoặc RViz ra sao?
\end{enumerate}
...
\href{https://drive.google.com/file/d/1D1ceJg4oJFvSS2aUksKp6LQNnHCnOOei/view?usp=sharing}{\textbf{xem video trên Google Drive}}.

Mã nguồn, world cảm biến và cấu hình RViz:
\href{https://github.com/thanhlamauto/ardu_plugin_gazebo}{\textbf{GitHub repository}}. Toàn bộ lệnh chạy lại nằm trong
\href{https://github.com/thanhlamauto/ardu_plugin_gazebo/blob/main/docs/closed_loop_runtime_walkthrough_vi.md}{\textbf{runbook thực nghiệm}}.
